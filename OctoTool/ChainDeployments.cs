...
namespace OctoTool
{
    public class ChainDeployments
    {
        ...
        /// given source Env to Target Env. By default, the deployment will start immediately, skip the disabled
        /// projects and follow the alphabetical order of projects' name.
        ...
        public static List<DeploymentResource> DeployProjectGroup(string groupName, GroupDeploymentPromotingSettings settings)
        {
